...
const symbolClass = (move) => {
    const classes = {
        ...
        only: move.nags.includes(14),
        equal: move.nags.includes(16),
        unclear: move.nags.includes(18),
        white_is_slightly_better: move.nags.includes(15),
        black_is_slightly_better: move.nags.includes(17),
        white_is_better: move.nags.includes(19),
        black_is_better: move.nags.includes(10),
        white_is_winning: move.nags.includes(13),
        black_is_winning: move.nags.includes(44),
        zugzwang: move.nags.includes(242),
        development: move.nags.includes(243),
        attack: move.nags.includes(146),
        initiative: move.nags.includes(132),
        with_compensation: move.nags.includes(7),
        counterplay: move.nags.includes(241),
        time_trouble: move.nags.includes(26),
        with_the_idea: move.nags.includes(138),
        novelty: move.nags.includes(22),
        king_side: move.nags.includes(36),
        queen_side: move.nags.includes(40),
        common_1: move.nags.includes(32),
        common_2: move.nags.includes(246),
        common_3: move.nags.includes(247),
        common_4: move.nags.includes(252),
        common_5: move.nags.includes(5002),
        common_6: move.nags.includes(5003),
        common_7: move.nags.includes(5004),
        common_8: move.nags.includes(5005),
        common_9: move.nags.includes(5006),
    };
...
export const renderMove = (ctrl) => (move, isVariation = false) => {
    return `<span data-ply="${move.ply}" id="move-${move.path.path}" data-nags="${move.nags}" data-fen="${move.fen}" data-uci="${move.uci}" data-path="${move.path.path}" data-variation="${isVariation}" class="${ctrl.path.path === move.path.path ? "active" : ""} move ${hasSymbol(move)} ${symbolClass(move)} ${isVariation ? "variation" : ""}"> ${move.san} </span>`;
};
...
export class PgnViewer {
     ...
     */
    hasAnyComment() {
        const checkNodeForComment = (node) => {
            // @ts-ignore
